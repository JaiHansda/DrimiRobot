...
import Drimi.modules.sql.language_sql as sql
from Drimi.langs import get_language, get_languages, get_string
from Drimi.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from Drimi.modules.helper_funcs.decorators import Drimicallback, Drimicmd
...
@Drimicallback(pattern=r"setLang_")
@user_admin_no_reply
